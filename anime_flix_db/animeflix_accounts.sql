...
CREATE TABLE `accounts` (
  ...
  `recover_code` varchar(7) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `accounts` VALUES (1,'Admin','admin@admin','$2y$10$knVQJpFgNAhqomtYMd0Hn.iUUBIa4CtPHhIIitZp0HK9nD5xZEYX6','0000-00-00',NULL);
